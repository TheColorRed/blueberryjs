class KeyboardHandler {
    ...
    public static inputHandler() {
        Blueberry.objects.forEach(object => {
            ...
            if (!object.element.onkeyup) {
                object.element.onkeyup = function (e) {
                    object.components.forEach(component => {
                        if (typeof component['keyUp'] == 'function' && e.currentTarget instanceof HTMLInputElement) {
                            component['keyUp'].bind(component).call(component, e);
                        }
                    });
                };
            }
